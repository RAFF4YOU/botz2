...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/6283823397743?text=SEWABOT
╰────
╭─[ *PAYMENT* ]
├  GOPAY
├  DANA
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/6283823397743?text=JADIBOT
╰────
╭─[ *PAYMENT* ]
├  GOPAY
├  DANA
...
let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        xavior.send5ButImg(m.chat, anu, '©RAFF4YOU', global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        xavior.send5ButGif(m.chat, anu, '©RAFF4YOU', global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        xavior.send5ButVid(m.chat, anu, '©RAFF4YOU', global.visoka, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        xavior.send5ButMsg(m.chat, anu, '©RAFF4YOU', btn)
                        } else if (setbot.templateLocation) {
                        xavior.send5ButLoc(m.chat, anu, '©RAFF4YOU', global.thumb, btn)
                        }
            break
case 'shoppepay': {
...
🤖 : Script Gak Dijual, Tapi Bisa Chat Owner
